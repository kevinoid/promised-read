...
[![Build Status](https://img.shields.io/github/workflow/status/kevinoid/promised-read/Node.js%20CI/master.svg?style=flat&label=build)](https://github.com/kevinoid/promised-read/actions?query=branch%3Amaster)
